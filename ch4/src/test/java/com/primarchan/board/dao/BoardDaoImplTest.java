...
public class BoardDaoImplTest {
    ...
    public void searchSelectPageTest() throws Exception {
        boardDao.deleteAll();
        for (int i = 1; i <= 20; i++) {
            BoardDto boardDto = new BoardDto("title" + i, "This is content.", "test" + i);
        ...
        sc = new SearchCondition(1, 10, "test2", "W");  // test2%
        list = boardDao.searchSelectPage(sc);
        assertTrue(list.size() == 2);  // test2, test20
    }
    ...
    public void searchResultCntTest() throws Exception {
        ...
        sc = new SearchCondition(1, 10, "test2", "W");
